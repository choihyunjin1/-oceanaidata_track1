...
RUNNER_PATH = ROOT / "scripts/run_p1_masked_pretrain_binary_event_v4.py"
SPEC = importlib.util.spec_from_file_location("p1_masked_pretrain_v4_runner_test", RUNNER_PATH)
...
def test_authorization_pins_all_inputs_implementations_and_v3() -> None:
    ...
    assert len(pins) == len(config["immutable_inputs"]) == 19

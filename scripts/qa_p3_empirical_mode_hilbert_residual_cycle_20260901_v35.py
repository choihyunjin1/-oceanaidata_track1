"""Independent post-run QA for P3 v35 empirical-mode/Hilbert residuals."""
...
def main() -> int:
    ...
    checks: dict[str, bool] = {
        ...
        "sealed_emd_hilbert_features": result["feature_receipt"]["columns"] == 80
    ...
    payload = {
        "schema_version": "p3.empirical_mode_hilbert_residual.independent_qa.v35",

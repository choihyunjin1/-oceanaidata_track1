...
OUT = Path("C:/Users/cedis/Documents/OceanFinalDay_20260907/P2_L120_s3_smooth7_proj_v2")
...
def build():
    ...
    archives = []
    commands = [["02_code/projection/p2_smooth7_portable_20260907_v2.py", mode] for mode in ["infer", "replay"]]
    for role in ["SOURCE_ONLY", "SAVED_MODELS"]:
        ...
        shutil.copy2(REPO / "scripts/p2_smooth7_portable_20260907_v2.py", target / "02_code/projection/p2_smooth7_portable_20260907_v2.py")
        ...
        (target / "CURRENT_README.md").write_text(
            ...
            "Historical PROJECT.ipynb and original README final-answer instructions are NOT execution entrypoints; use only the notebook sequence above. Historical output SHA equality is recorded, not a cross-hardware acceptance gate; current-run integrity QA and replay still must pass. No CPU fallback added.\n\n"

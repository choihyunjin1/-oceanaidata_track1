"""Check or execute the append-only P3 Gen5r4 dense72 correction."""
...
GUARD_MODULE = "p3_wave.hierarchical_residual_basis_dense72_contract_r4"
GUARD_RELATIVE = "src/p3_wave/hierarchical_residual_basis_dense72_contract_r4.py"
ENGINE_MODULE = "p3_wave.hierarchical_residual_basis_dense72_execution_r4"
ENGINE_RELATIVE = "src/p3_wave/hierarchical_residual_basis_dense72_execution_r4.py"
...
def check_only(
    *,
    ...
    _canonical_module(guard, workspace / GUARD_RELATIVE, name="Gen5r4 guard")
    ...
    return {
        "schema_version": "p3_hierarchical_residual_basis.gen5r4_dense72.check_only.r1",
...
def run_once(
    *,
    ...
    try:
        ...
        _canonical_module(engine, workspace / ENGINE_RELATIVE, name="Gen5r4 engine")
        execute = getattr(engine, "execute_curve_stage", None)
        if not callable(execute):
            raise RuntimeError("canonical Gen5r4 engine lacks execute_curve_stage")
        result = execute(

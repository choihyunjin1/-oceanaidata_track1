"""Independent QA entrypoint for P3 v75 matrix-pencil mode geometry."""
...
def main() -> int:
    payload = run_qa(
        ...
        feature_count=72,
        no_go_decision="NO_GO_ALL_MATRIX_PENCIL_CANDIDATES",
        schema_version="p3.matrix_pencil_mode_residual.independent_qa.v75",
    )
    print(
        json.dumps(
            {

"""Independent post-run QA for P3 v34 bicoherence residuals."""
...
def main() -> int:
    ...
    checks: dict[str, bool] = {
        ...
        == "NO_GO_ALL_BICOHERENCE_CANDIDATES",
        ...
        "sealed_bicoherence_features": result["feature_receipt"]["columns"] == 72
    ...
    payload = {
        "schema_version": "p3.bicoherence_residual.independent_qa.v34",

"""Lifecycle-safe independent post-terminal QA for P1 v9 dependence change."""
...
def _module():
    spec = importlib.util.spec_from_file_location("p1_v9_qa_runner", RUNNER)
...
def verify(data_dir: Path) -> dict[str, Any]:
    ...
    long_event = runner._long_event_interior(
        truth,
        incumbent,
        candidate,
        metadata,

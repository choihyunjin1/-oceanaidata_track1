"""Exactly-once clean historical P3 TabPFN-3 residual confirmation."""
...
from ocean_tabpfn3.offline import canonical_json_bytes, make_regressor, require_ready, sha256
...
EXPERIMENT_ID = "p3_tabpfn3_structural_transition_20260901_v1r1"
...
def lead_specific_matrix(frame: pd.DataFrame, *, lead: int) -> np.ndarray:
    ...
    station_map = {"G-ORS": 0.0, "I-ORS": 1.0, "S-ORS": 2.0}
...
def preflight() -> dict[str, Any]:
    ...
    return {
        "schema_version": "p3.tabpfn3.structural_transition.preflight.v1",
...
def execute() -> dict[str, Any]:
    ...
    config = _config()
    lock = {
        "schema_version": "p3.tabpfn3.attempt.v1",
        "experiment_id": EXPERIMENT_ID,
    ...
    try:
        ...
        result = {
            "schema_version": "p3.tabpfn3.structural_transition.result.v1",
            "experiment_id": EXPERIMENT_ID,
            "status": (
        ...
        failure = {
            "schema_version": "p3.tabpfn3.structural_transition.terminal.v1",
            "experiment_id": EXPERIMENT_ID,

"""Independent QA entrypoint for P3 v71 equilibrium-error geometry."""
...
def main() -> int:
    payload = run_qa(
        ...
        feature_count=32,
        no_go_decision="NO_GO_ALL_EQUILIBRIUM_ERROR_CANDIDATES",
        schema_version="p3.equilibrium_error_residual.independent_qa.v71",
    )

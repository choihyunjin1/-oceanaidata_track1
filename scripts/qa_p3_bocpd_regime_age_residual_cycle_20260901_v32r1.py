"""Independent post-run QA for P3 v32r1 log-domain BOCPD recovery."""
...
def main() -> int:
    ...
    checks: dict[str, bool] = {
        ...
        "terminal_no_go": result["decision"] == "NO_GO_ALL_BOCPD_CANDIDATES",
        ...
        "sealed_bocpd_features": result["feature_receipt"]["columns"] == 96
        ...
        and result["provenance"]["source_runner_sha256"]
        == qa.sha256(SOURCE_RUNNER)
        ...
        and result["execution"]["numerical_adapter_changes"] == 1,
    ...
    payload = {
        "schema_version": "p3.bocpd_regime_age_residual.recovery_independent_qa.v32r1",

"""Fail-closed CLI for the P2 joint-hydrographic Layer-4 v1 curve."""
...
GUARD_MODULE = "p2_restore.joint_hydrographic_multitask_layer4_contract_v1"
ENGINE_MODULE = "p2_restore.joint_hydrographic_multitask_layer4_execution_v1"
GUARD_RELATIVE = "src/p2_restore/joint_hydrographic_multitask_layer4_contract_v1.py"
...
def run_authorized(
    *,
    ...
    return {
        "schema_version": "p2_joint_hydrographic_multitask_layer4.run.v1",

"""Lifecycle-safe independent QA for P1 v18 conditional diffusion."""
...
def verify(data_dir: Path) -> dict[str, object]:
    qa = _module(ROOT / "scripts/qa_p1_v11_causal_wavelet_scattering_addonly_20260901_v1.py", "p1_v18_shared_qa")
    ...
    runner = _module(qa.RUNNER, "p1_v18_boundary_qa")

"""Independent QA entrypoint for P3 v66 sequential record process."""
...
def main() -> int:
    payload = run_qa(
        ...
        feature_count=64,
        no_go_decision="NO_GO_ALL_RECORD_PROCESS_CANDIDATES",
        schema_version="p3.record_process_residual.independent_qa.v66",
    )
    print(
        json.dumps(
            {

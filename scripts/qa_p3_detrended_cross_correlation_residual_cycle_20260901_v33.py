"""Independent post-run QA for P3 v33 DCCA residuals."""
...
def main() -> int:
    ...
    checks: dict[str, bool] = {
        ...
        "terminal_no_go": result["decision"] == "NO_GO_ALL_DCCA_CANDIDATES",
        ...
        "sealed_dcca_features": result["feature_receipt"]["columns"] == 66
    ...
    for candidate, prediction in zip(
        result["candidates"], predictions, strict=True
    ):
    ...
    payload = {
        "schema_version": "p3.detrended_cross_correlation_residual.independent_qa.v33",

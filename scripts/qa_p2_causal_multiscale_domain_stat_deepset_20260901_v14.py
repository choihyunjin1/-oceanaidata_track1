"""Independent metric, prefix, representation, hash, and access QA for P2 v14."""
...
import run_p2_causal_multiscale_domain_stat_deepset_20260901_v14 as runner  # noqa: E402
...
def main() -> None:
    ...
    checks = {
        ...
        "new_representation": result["semantic_audit"]["classification"]
        == "NEW_FIXED_CAUSAL_DOMAIN_STAT_REPRESENTATION",
        "fixed_horizons": result["representation"]["half_life_steps"] == [144, 1008, 4320],
        "causal_shift": result["representation"]["causal_shift_rows"] == 1,
        "token_width": result["representation"]["total_token_features"] == 20,
    ...
    qa = {
        "schema_version": "p2.causal_multiscale_domain_stat_deepset.independent_qa.20260901.v14",

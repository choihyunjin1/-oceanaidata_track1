"""Independent QA entrypoint for P3 v65 L-moment shape."""
...
def main() -> int:
    payload = run_qa(
        ...
        feature_count=64,
        no_go_decision="NO_GO_ALL_LMOMENT_CANDIDATES",
        schema_version="p3.lmoment_shape_residual.independent_qa.v65",
    )
    print(
        json.dumps(
            {

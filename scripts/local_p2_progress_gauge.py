...
def main() -> int:
    ...
    title = ttk.Label(root, text="P2 모델 실험", font=("Malgun Gothic", 16, "bold"))
    title.pack(anchor="w")
    ...
    def refresh() -> None:
        try:
            ...
            window_title = str(value.get("title", "P2 모델 실험"))
            title.configure(text=window_title)

"""Exactly-once historical P1 TabPFN-2.6 structural transition.
...
from ocean_tabpfn26.offline import canonical_json_bytes, make_classifier, require_ready, sha256

EXPERIMENT_ID = "p1_tabpfn26_structural_transition_20260901_v1"
...
def preflight() -> dict[str, Any]:
    ...
    return {
        "schema_version": "p1.tabpfn26.structural_transition.preflight.v1",
        "status": "READY",
...
def _phase_prediction(
    *,
    ...
    receipt = {
        "schema_version": "p1.tabpfn26.blind_receipt.v1",
        "experiment_id": EXPERIMENT_ID,
        "phase": phase,
...
def execute() -> dict[str, Any]:
    ...
    config = _config()
    lock = {
        "schema_version": "p1.tabpfn26.attempt.v1",
        "experiment_id": EXPERIMENT_ID,
    ...
    try:
        ...
        if q2_metrics["delta_f1"] <= 0.0:
            result = {
                "schema_version": "p1.tabpfn26.structural_transition.result.v1",
                "experiment_id": EXPERIMENT_ID,
        ...
        failure = {
            "schema_version": "p1.tabpfn26.structural_transition.terminal.v1",
            "experiment_id": EXPERIMENT_ID,

"""Independent QA entrypoint for P3 v67 Pettitt rank-change geometry."""
...
def main() -> int:
    payload = run_qa(
        ...
        feature_count=64,
        no_go_decision="NO_GO_ALL_PETTITT_CANDIDATES",
        schema_version="p3.pettitt_rank_change_residual.independent_qa.v67",
    )

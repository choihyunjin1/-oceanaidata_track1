"""Independent QA entrypoint for P3 v40 level crossings."""
...
def main() -> int:
    payload = run_qa(
        ...
        feature_count=72,
        no_go_decision="NO_GO_ALL_LEVEL_CROSSING_CANDIDATES",
        schema_version="p3.level_crossing_excursion_residual.independent_qa.v40",
    )

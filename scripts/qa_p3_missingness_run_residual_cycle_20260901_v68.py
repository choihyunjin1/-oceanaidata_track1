"""Independent QA entrypoint for P3 v68 missingness-run geometry."""
...
def main() -> int:
    payload = run_qa(
        ...
        feature_count=80,
        no_go_decision="NO_GO_ALL_MISSINGNESS_RUN_CANDIDATES",
        schema_version="p3.missingness_run_residual.independent_qa.v68",
    )

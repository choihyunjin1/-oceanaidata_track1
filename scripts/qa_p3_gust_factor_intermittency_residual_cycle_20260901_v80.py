"""Independent QA entrypoint for P3 v80 gust-factor intermittency."""
...
def main() -> int:
    payload = run_qa(
        ...
        feature_count=16,
        no_go_decision="NO_GO_ALL_GUST_FACTOR_CANDIDATES",
        schema_version="p3.gust_factor_intermittency_residual.independent_qa.v80",
    )

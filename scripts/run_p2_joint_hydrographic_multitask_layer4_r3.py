"""Fail-closed CLI for the P2 joint-hydrographic Layer-4 r3 curve."""
...
GUARD_MODULE = "p2_restore.joint_hydrographic_multitask_layer4_contract_r3"
ENGINE_MODULE = "p2_restore.joint_hydrographic_multitask_layer4_execution_r3"
GUARD_RELATIVE = "src/p2_restore/joint_hydrographic_multitask_layer4_contract_r3.py"
...
def run_authorized(
    *,
    ...
    return {
        "schema_version": "p2_joint_hydrographic_multitask_layer4.run.r3",

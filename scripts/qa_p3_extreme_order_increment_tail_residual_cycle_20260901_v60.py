"""Independent QA entrypoint for P3 v60 extreme-order increment tails."""
...
def main() -> int:
    payload = run_qa(
        ...
        feature_count=72,
        no_go_decision="NO_GO_ALL_EXTREME_ORDER_TAIL_CANDIDATES",
        schema_version="p3.extreme_order_increment_tail_residual.independent_qa.v60",
    )

...
1. latest written organizer rule or direct organizer answer; the active document is `00_ORGANIZER_DATA_POLICY.md`, including the 2026-09-02 score-use supplement verified on 2026-09-05
...
- Do not solve model coefficients, thresholds, parameters, per-row labels, or Public membership from returned leaderboard scores. Ordinary comparison of already fitted candidate models is distinct and allowed. Historical "clean" labels certify only their recorded scope, not eligibility under later rules.
